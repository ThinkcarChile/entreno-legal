-- SEED DE DESARROLLO — Sprint 4 (NO aplicar en producción sin revisión)
--
-- No inserta filas: define una función que carga la familia de demostración
-- DENTRO del hogar que ya existe. Un seed de datos personales no puede
-- adivinar a qué hogar pertenece, y crear un hogar paralelo dejaría la demo
-- separada de la familia real.
--
-- Todos los valores son configuración EDITABLE de cada integrante, nunca lógica
-- del sistema (§9). No hay macros clínicos inventados: la salud llega en un
-- sprint posterior.
