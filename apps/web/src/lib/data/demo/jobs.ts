...
const jobSeeds: readonly JobSeed[] = [
  ...
  },
  {
    ...
    categoryId: "cat-fila-instituciones",
    status: JobStatus.PUBLISHED,
    title: "Fila en oficina de atención ciudadana en Valparaíso",
    description:
      "La atención es por orden de llegada y el número se acaba antes de las 09:00. Necesito que alguien tome lugar desde las 07:00 y me avise cuando falten dos o tres personas, para llegar yo a hacer el trámite.",
    instructions:
      "Es solo guardar el lugar: el trámite lo hago yo, porque exige la presencia del titular.",
    regionCode: "05",
    communeCode: "05-valparaiso",
    addressLine: "Av. Pedro Montt 1881, Valparaíso",
    lat: -33.0472,
    lng: -71.6127,
    startsAt: inDays(2, 7, 0),
    durationMinutes: 150,
    urgency: JobUrgency.NORMAL,
    objectiveType: JobObjectiveType.HOLD_PLACE,
    hourlyRate: 8_000,
  ...
  },
  {
    ...
    categoryId: "cat-tramite-pedidos",
    status: JobStatus.PUBLISHED,
    title: "Retirar un pedido en el centro de La Serena",
    description:
      "El pedido está pagado y listo para retiro, pero el horario de la tienda choca con mi turno. Necesito que alguien lo retire y me lo deje en la conserjería del edificio, que está a diez cuadras.",
    instructions:
      "El retiro va a mi nombre con un código que envío por el chat. Si piden cédula del titular, no se insiste: se avisa y se cancela.",
    regionCode: "04",
    communeCode: "04-la-serena",
    addressLine: "Av. Francisco de Aguirre 220, La Serena",
    lat: -29.9027,
    lng: -71.2519,
    startsAt: inDays(1, 16, 30),
    durationMinutes: 90,
  ...
  },
  {
    ...
    reference: "HTF-2610",
    clientId: "usr-client-4",
    categoryId: "cat-fila-lanzamientos",
    status: JobStatus.PUBLISHED,
    title: "Fila por lanzamiento de zapatillas en Temuco",
    description:
      "Stock muy limitado y la tienda reparte números a las 10:00. Busco a alguien que llegue temprano, aguante el frío y mande fotos de cómo avanza la fila.",
    instructions:
      "La fila se forma en la vereda, no dentro del mall. Llevar abrigo: a esa hora suele estar bajo cero.",
    regionCode: "09",
    communeCode: "09-temuco",
    addressLine: "Av. Alemania 0671, Temuco",
    lat: -38.7359,
    lng: -72.5904,
    startsAt: inDays(4, 6, 0),
    durationMinutes: 240,
    urgency: JobUrgency.NORMAL,
    objectiveType: JobObjectiveType.WITHIN_FIRST_N,
    targetPosition: 20,
    bonus: 10_000,
    bonusConditions: "Se paga si al entregar el lugar quedaste entre los primeros 20.",
    hourlyRate: 9_500,
    offerCount: 2,
    viewCount: 88,
  ...
  },
  {
    ...
    categoryId: "cat-tramite-espera",
    status: JobStatus.PUBLISHED,
    title: "Esperar una entrega de electrodoméstico en Puerto Montt",
    description:
      "La entrega llega en una ventana de cuatro horas y yo estoy embarcado ese día. Necesito que alguien reciba el refrigerador, revise que no venga golpeado y firme el acta de recepción con su propio nombre.",
    instructions:
      "Dejo aviso en portería. Si el repartidor exige la firma del titular, se avisa por el chat y no se firma nada a mi nombre.",
    regionCode: "10",
    communeCode: "10-puerto-montt",
    addressLine: "Av. Diego Portales 1450, Puerto Montt",
    lat: -41.4693,
    lng: -72.9424,
    startsAt: inDays(3, 8, 0),
    durationMinutes: 240,
    urgency: JobUrgency.FLEXIBLE,
    objectiveType: JobObjectiveType.COMPLETE_ERRAND,
    objectiveDescription: "Recibir la entrega y revisar el estado del producto.",
    hourlyRate: 8_500,
    offerCount: 0,
    viewCount: 19,
    publishedHoursAgo: 9,
