      ...
      <CardContent className="flex h-full flex-col">
        <div className="flex items-start gap-3.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 truncate text-sm text-ink-500">{worker.profile.city}</p>
        ...
        <div className="mt-auto flex items-center justify-between gap-3 border-t border-ink-100 pt-4">
          ...
          <HourlyRate value={worker.baseHourlyRate} className="font-semibold text-ink-900" />
        </div>
      </CardContent>
    </Card>
  );
