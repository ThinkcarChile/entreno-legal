  ...
  return (
    <div className="flex gap-3.5">
      ...
      <div className="min-w-0">
        <p className="text-caption font-medium tracking-wide text-ink-500 uppercase">Dónde</p>
        <div className="mt-1 text-[0.9375rem] text-ink-700">
          {location.placeName && (
            <span className="block font-medium text-ink-950">{location.placeName}</span>
          )}
          ...
          {location.exact ? (
            ...
            <span className="mt-0.5 flex items-center gap-1.5 text-small text-ink-500">
