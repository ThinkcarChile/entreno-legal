  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="rounded-[var(--radius-control)] border border-ink-200 bg-ink-50/60 p-4">
      ...
      <fieldset>
        <legend className="text-sm font-medium text-ink-800">¿Qué tan urgente es?</legend>
